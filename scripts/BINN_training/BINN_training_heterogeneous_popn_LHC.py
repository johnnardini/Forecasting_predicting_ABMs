...
from get_params import get_heterog_LHC_params_vary_Padh_Ppull_alpha
...
if __name__ == '__main__':
    ...
    params = np.array(get_heterog_LHC_params_vary_Padh_Ppull_alpha("Training"))

    PmH, PmP, Pp, Padh, Ppull, alpha = np.round(params[int(sys.argv[1]),:],3)
    ...
    model_selection((PmH, PmP, Pp, Padh, Ppull, alpha), scenario = "heterogeneous", pde_weight=pde_weight, n=n)
    
    simulate_binn_DE((PmH, PmP, Pp, Padh, Ppull, alpha),scenario)
